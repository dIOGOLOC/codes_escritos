...
Travel_times_folder = OUTPUT_DIR+'MODEL_INTER_DEPTH_'+str(INTER_DEPTH)+'_DEPTH_MOHO_'+str(DEPTH_MOHO)+'_DEPTH_LAB_'+str(DEPTH_LAB)+'/'+'Phases'+'/'
...
with Pool(processes=MP_PROCESSES,maxtasksperchild=2) as pool_Pds:
	pool_Pds.starmap(parallel_travel_times_Pds, input_list,chunksize=1)
