...
print('\n')
print('Looking for STATIONS data in FEATHER file in '+OUTPUT_DIR+'FEATHER/')
print('\n')
...
filename_RF = OUTPUT_DIR+'FEATHER/'+FEATHER_FILE_NAME+'.feather'
dic_RF = pd.read_feather(filename_RF)

filename_STA = OUTPUT_DIR+'FEATHER/'+'STA_dic.feather'
