...
DATE_DAY = '2020-03-13T02:13:10.080000'
...
STATIONS_LST = ['DUB01','CAM01','ABR01','RIB01','GUA01']
...
axis_major = SecondLocator(interval=15)   # every 5-second
axis_minor = SecondLocator(interval=5)   # every 1-second
axis_Fmt = DateFormatter('%H:%M:%S')

plt.rcParams.update({'font.size': 25})
fig, axes = plt.subplots(ncols=2, nrows=len(stZ),figsize=(25,25),sharex='col')
fig.suptitle('Event Date: '+FDAY.strftime('%d/%m/%Y'),y=0.95,fontsize=25)
