...
if RAY_TRACE_410_660_PLOT == True:
	...
	fig_ray_path_410_660.savefig(RAY_PATH_FIGURE+'ray_path_'+str(DEPTH_1)+'_'+str(DEPTH_2)+'_PPVs.'+EXT_FIG,dpi=DPI_FIG)
else: 
	pass
...
fig_grid_points.savefig(PP_FIGURE+'BINNED_DATA_PPvs.'+EXT_FIG,dpi=DPI_FIG)
...
fig_receiver_function_per_bin.savefig(PP_FIGURE+'RECEIVER_FUNCTION_PER_BIN_PPvs.'+EXT_FIG,dpi=DPI_FIG)
