...
from pre_processing_py.trim_seismogram import cut_NO_PP_data_by_event
...
def parallel_trim_data(kstnm,stla,stlo,ev_timeUTC,ev_julday,ev_year,ev_month,ev_day,ev_hour,ev_minute,ev_second,ev_microsecond,	ev_lat,ev_long,ev_depth,ev_mag):
	...
	station_data_result = cut_NO_PP_data_by_event(kstnm=kstnm,stla=stla,stlo=stlo,ev_timeUTC=ev_timeUTC,ev_julday=ev_julday,ev_year=ev_year,ev_month=ev_month,
