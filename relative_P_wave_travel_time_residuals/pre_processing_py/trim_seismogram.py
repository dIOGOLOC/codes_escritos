	...
	if os.path.isdir(DIR_SAC+kstnm+'/'+ev_year+'/'+ev_month+'/'+ev_day) == True:
		try:
			...
			if EV_GCARC_MIN <= gcarc <= EV_GCARC_MAX and EV_MAGNITUDE_MB <= ev_mag:
				...
				event_directory = DIR_EVENT+kstnm+'/'+'{:03}'.format(starttime.year)+'/'+'{:03}'.format(starttime.julday)+'/'+'{:03}'.format(starttime.year)+'.'+'{:03}'.format(starttime.julday)+'.'+'{:03}'.format(starttime.hour)+'.'+'{:03}'.format(starttime.minute)+'.'+'{:03}'.format(starttime.second)+'.'+'{:03}'.format(starttime.microsecond)			
				...
				sacHHX.write(event_directory+'/'+knetwk+'.'+kstnm+'.'+'{:03}'.format(starttime.year)+'.'+'{:03}'.format(starttime.julday)+'.'+'{:03}'.format(starttime.hour)+'.'+'{:03}'.format(starttime.minute)+'.'+'{:03}'.format(starttime.second)+'.'+'{:03}'.format(starttime.microsecond)+'.'+NAME_SUFFIX_E)
				...
				sacHHY.write(event_directory+'/'+knetwk+'.'+kstnm+'.'+'{:03}'.format(starttime.year)+'.'+'{:03}'.format(starttime.julday)+'.'+'{:03}'.format(starttime.hour)+'.'+'{:03}'.format(starttime.minute)+'.'+'{:03}'.format(starttime.second)+'.'+'{:03}'.format(starttime.microsecond)+'.'+NAME_SUFFIX_N)
				...
				sacHHZ.write(event_directory+'/'+knetwk+'.'+kstnm+'.'+'{:03}'.format(starttime.year)+'.'+'{:03}'.format(starttime.julday)+'.'+'{:03}'.format(starttime.hour)+'.'+'{:03}'.format(starttime.minute)+'.'+'{:03}'.format(starttime.second)+'.'+'{:03}'.format(starttime.microsecond)+'.'+NAME_SUFFIX_Z)
